...
const url = 'https://github.com/Seyuko/Pictures/blob/master/bg.jpg?raw=true'
...
const styles = {
  backgroundBox: {
    ...
    width: '100vw',
    height: '100vh',
    backgroundImage: 'url(https://github.com/Seyuko/Pictures/blob/master/bg1.jpg?raw=true)',
